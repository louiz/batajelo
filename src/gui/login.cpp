...
{
  this->window_menu->SetPosition(sf::Vector2f(100.f*Config::get_int("width", 800)/1920.f, 800.f*Config::get_int("height", 600)/1080.f));
  this->window_login->SetPosition(sf::Vector2f(750.f*Config::get_int("width", 800)/1920.f, 400.f*Config::get_int("height", 600)/1080.f));
