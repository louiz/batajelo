...
Ui::Ui(Game* game): game(game)
{
  ...
  this->font_path = Config::get("font_path", "C:/Work/pelaze/git/batajelo/data/fonts/").data();
  this->theme_path = Config::get("theme_path", "C:/Work/pelaze/git/batajelo/data/themes/").data();
  this->img_path = Config::get("img_path", "C:/Work/pelaze/git/batajelo/data/images/").data();
...
void Ui::on_authenticate(Command* received_command)
{
  ...
  if (res == 0)
    {
      this->home->on_authenticate_success();
