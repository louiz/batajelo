...
{
  this->window_settings->SetAllocation(sf::FloatRect(300.f*Config::get_float("width", 600.f)/1920.f, 200.f*Config::get_float("height", 600.f)/1080.f, 1200.f*Config::get_float("width", 600.f)/1920.f, 600.f*Config::get_float("height", 600.f)/1080.f));
...
void Settings::build_ui()
{
  ...
  this->window_settings->SetAllocation(
    sf::FloatRect(
      300.f*Config::get_float("width", 600.f)/1920.f,
      200.f*Config::get_float("height", 600.f)/1080.f,
      1200.f*Config::get_float("width", 600.f)/1920.f, 
      600.f*Config::get_float("height", 600.f)/1080.f
    )
  );
  this->window_settings->Show(false);
  // Desktop
...
void Settings::update()
{
  ...
  if ((width != Config::get_int("width", 800)) ||
      ...
      (this->display->GetSelectedItem() != Config::get_int("display", 2)))
    {
